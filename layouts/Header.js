...
import { getImagePath } from '@/utility/images';
                  ...
                  <div className="row g-4">
                    <div className="col-xl-2 homemenu">
                      <div className="homemenu-thumb">
                        <img src={getImagePath('assets/img/header/home-1.jpg')}  alt="img" />
                    ...
                    <div className="col-xl-2  homemenu">
                      <div className="homemenu-thumb">
                        <img src={getImagePath('assets/img/header/home-2.jpg')}  alt="img" />
                        <div className="demo-button">
                    ...
                    <div className="col-xl-2 homemenu">
                      <div className="homemenu-thumb">
                        <img src={getImagePath('assets/img/header/home-3.jpg')}  alt="img" />
                        <div className="demo-button">
                    ...
                    <div className="col-xl-2 homemenu">
                      <div className="homemenu-thumb">
                        <img src={getImagePath('assets/img/header/home-4.jpg')}  alt="img" />
                        <div className="demo-button">
                    ...
                    <div className="col-xl-2 homemenu">
                      <div className="homemenu-thumb">
                        <img src={getImagePath('assets/img/header/home-5.jpg')}  alt="img" />
                        <div className="demo-button">
                    ...
                    <div className="col-xl-2 homemenu">
                      <div className="homemenu-thumb">
                        <img src={getImagePath('assets/img/header/home-6.jpg')}  alt="img" />
                        <div className="demo-button">
            ...
            <div className="offcanvas__content">
              <div className="offcanvas__top mb-5 d-flex justify-content-between align-items-center">
                <div className="offcanvas__logo">
                  <Link href="/">
                    <img src={getImagePath('assets/img/logo/black-logo.svg')} alt="logo-img" />
                  </Link>
                </div>
          ...
          <div className="mega-menu-wrapper">
            <div className="header-main">
              <div className="sticky-logo">
                ...
                <Link href="/">
                  <img
                    src={getImagePath('assets/img/logo/black-logo.svg')}
                    alt="logo-img"
                    className="logo-2"
                  />
                </Link>
